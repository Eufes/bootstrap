...
//  IntegrationProcessID - Строка - Идентификатор интеграционного процесса (Справочника QIWI_АдаптерИнтеграционныеПроцессы) 
...
Функция Interaction(MsgType, MsgID, MsgBody, ExternalSystemID, IntegrationProcessID = "", BodyType = "")
	...
	Попытка 
		Результат = QIWI_АдаптерОбмен.ОбработатьВходящийЗапрос(MsgType, MsgID, MsgBody,
	...
	Исключение
		...
		QIWI_АдаптерВызовСервера.ВыполнитьЛогирование("Ошибка получения данных внешней системой "
